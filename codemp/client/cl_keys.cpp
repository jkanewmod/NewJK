...
keyname_t keynames[MAX_KEYS] =
{
	...
	{ (word)'A', (word)'a', "A", A_CAP_A, false						},
	{ (word)'B', (word)'b', "B", A_CAP_B, false						},
	{ (word)'C', (word)'c', "C", A_CAP_C, false						},
	{ (word)'D', (word)'d', "D", A_CAP_D, false						},
	{ (word)'E', (word)'e', "E", A_CAP_E, false						},
	{ (word)'F', (word)'f', "F", A_CAP_F, false						},
	{ (word)'G', (word)'g', "G", A_CAP_G, false						},
	{ (word)'H', (word)'h', "H", A_CAP_H, false						},
	{ (word)'I', (word)'i', "I", A_CAP_I, false						},
	{ (word)'J', (word)'j', "J", A_CAP_J, false						},
	{ (word)'K', (word)'k', "K", A_CAP_K, false						},
	{ (word)'L', (word)'l', "L", A_CAP_L, false						},
	{ (word)'M', (word)'m', "M", A_CAP_M, false						},
	{ (word)'N', (word)'n', "N", A_CAP_N, false						},
	{ (word)'O', (word)'o', "O", A_CAP_O, false						},
	{ (word)'P', (word)'p', "P", A_CAP_P, false						},
	{ (word)'Q', (word)'q', "Q", A_CAP_Q, false						},
	{ (word)'R', (word)'r', "R", A_CAP_R, false						},
	{ (word)'S', (word)'s', "S", A_CAP_S, false						},
	{ (word)'T', (word)'t', "T", A_CAP_T, false						},
	{ (word)'U', (word)'u', "U", A_CAP_U, false						},
	{ (word)'V', (word)'v', "V", A_CAP_V, false						},
	{ (word)'W', (word)'w', "W", A_CAP_W, false						},
	{ (word)'X', (word)'x', "X", A_CAP_X, false						},
	{ (word)'Y', (word)'y', "Y", A_CAP_Y, false						},
	{ (word)'Z', (word)'z', "Z", A_CAP_Z, false						},
