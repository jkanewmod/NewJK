...
#define NEWJK_VERSION "1.4.11"

#if defined(_DEBUG)
	#define	JK_VERSION		"(debug)NewJK (" NEWJK_VERSION "): v" VERSION_STRING_DOTTED
#else
	#define	JK_VERSION		"NewJK (" NEWJK_VERSION "): v" VERSION_STRING_DOTTED
#endif
